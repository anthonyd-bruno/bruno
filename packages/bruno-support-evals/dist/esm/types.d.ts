export declare const supportEvalCategories: readonly ["install", "cli", "scripting", "auth", "pricing", "troubleshooting", "version_release", "fallback", "escalation"];
export declare const supportEvalDifficulties: readonly ["easy", "medium", "hard"];
export declare const supportEvalSourceTypes: readonly ["repo", "docs_site", "website", "github", "stackoverflow"];
export declare const supportEvalTrustTiers: readonly ["official_docs", "repo", "community", "external"];
export declare const supportEvalCitationImportances: readonly ["required", "recommended"];
export declare const supportEvalFallbackPolicies: readonly ["never", "allowed", "required"];
export declare const supportEvalEscalationChannels: readonly ["security_email", "docs", "github_discussions", "github_issues", "pricing", "downloads"];
export declare const supportEvalDeliveryStages: readonly ["wave1_seed"];
export declare const supportEvalMetricNames: readonly ["groundedness", "citationPrecision", "correctness", "fallbackQuality"];
export declare const supportEvalCaseRunStatuses: readonly ["completed", "failed"];
export declare const supportEvalGateStatuses: readonly ["passed", "failed"];
export declare const supportEvalGateFailureCodes: readonly ["failed_case_count", "metric_threshold"];
export declare const supportBotFeedbackSignalSources: readonly ["telemetry", "eval"];
export declare const supportBotFeedbackSignalTypes: readonly ["unanswered", "request_failure", "citation_gap", "eval_failure", "quality_gap"];
export declare const supportBotFeedbackSeverities: readonly ["low", "medium", "high", "critical"];
export declare const supportBotFeedbackGapTypes: readonly ["content_gap", "citation_gap", "routing_gap", "retrieval_gap", "generation_gap", "validation_gap", "quality_gap"];
export declare const supportBotFeedbackTelemetryFailureStages: readonly ["request_validation", "retrieval", "generation", "response_validation", "unknown", "eval_execution"];
export declare const supportBotFeedbackCitationSignals: readonly ["sufficient", "low_citation", "citation_miss", "not_applicable"];
export declare const supportBotFeedbackOutcomes: readonly ["answer", "fallback", "sources"];
...
export type SupportBotFeedbackTelemetryEvent = SupportBotFeedbackTelemetryCompletedEvent | SupportBotFeedbackTelemetryFailedEvent | SupportBotFeedbackTelemetryIgnoredEvent;
